...
function hook_default(funcName, funcParent, funcArgs, ctxt, isConstruct) {
  ...
  let workingRetVal = [...patch.i.values()].reduce((prev, current) => (...args) => current.call(ctxt, args, prev), (...args) => isConstruct ? Reflect.construct(patch.o, args, ctxt) : patch.o.apply(ctxt, args))(...funcArgs);
